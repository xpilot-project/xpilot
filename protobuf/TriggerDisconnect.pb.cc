...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_TriggerDisconnect_2eproto_getter() {
  return &descriptor_table_TriggerDisconnect_2eproto;
}
...
::PROTOBUF_NAMESPACE_ID::Metadata TriggerDisconnect::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_TriggerDisconnect_2eproto_getter, &descriptor_table_TriggerDisconnect_2eproto_once,
      file_level_metadata_TriggerDisconnect_2eproto[0]);
}
